...
// MultiThreadDemo.cpp : Defines the class behaviors for the application.
//
...
// CMultiThreadDemoApp construction
...
// The one and only CMultiThreadDemoApp object

CMultiThreadDemoApp theApp;


// CMultiThreadDemoApp initialization
